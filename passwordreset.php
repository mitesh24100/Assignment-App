...
<body style="background-color: #343A40">
	<br><h3 align = "center" style = "font-family: monospace; font-size: 30px; color: #FDF6F6;">Reset Password</h3><br>
	<form method = "POST" action = "passwordreset1.php?email=<?php echo $first;?>" class = "text-center"> 
