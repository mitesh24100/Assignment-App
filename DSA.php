...
$sql1 = $con->query("SELECT * FROM `DSA` ORDER BY ID DESC LIMIT 1"); 
...
<body style="background-color: #343A40">
	<form method="POST" action="DSASubmit.php?email=<?php echo $mail;?>">
		<div class="container">
			<div class="row">
				<div class="col" align="center">
					<h2 align="center" style = "font-family: monospace; font-size: 32px; color: #FDF6F6;">Automata Theory</h2>
				</div>
			</div>
			<div class="row">
				<div class="col" align="center">
		...
		<div class = "col-12" align = "center">
			<br><h2><a href = "index.php?email=<?php echo $mail;?>" style = "font-family: monospace; font-size: 25px; text-decoration: none; color: #FF0000;"><-- DashBoard!</a><h2>
		</div>
	</form>
</body>
</html>