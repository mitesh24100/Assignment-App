...
if(isset($_POST['submit']))
	{
		...
		foreach($_POST['attendance_status'] as $RollNo=>$attendance_status)
		{
			...
			$output = $con->query("INSERT INTO seitadbms (RollNo, Name, Attendance_Status, Date) VALUES ('$RNo', '$Name', '$attendance_status', '$date')");
		}
		if($output)
		{
				header('thankyou.php');
...
<div class="container">
	<div class="panel panel-default">
		...
		<div class="panel panel-body">
			<form action="seitadbms.php" method="POST">
				<input type="hidden" value="<?php echo $date?>" name="date">
				<table class="table table-striped">
					<th>Roll Number</th><th>Name</th><th>Attendance Status</th>
					<?php $result = $con->query("SELECT * FROM seitaattendance");
						  $counter = 0;
